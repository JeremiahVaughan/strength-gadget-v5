...
b:
	...
	ssh "piegarden@173.197.226.162" "cd local.strengthgadget.com && sudo docker compose -f docker-compose-local down || true && sudo docker compose -f docker-compose-local.yaml -p local up -d"
